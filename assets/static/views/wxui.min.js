...
webix.attachEvent("onLoadError",function(a,b){console.log(a.responseText);console.log(b.config)});tr=function(a,b){return b};wxui.tr=tr;gtr=function(a){return tr("global",a)};wxui.removeFromArray=function(a,b){for(var c=0;c<a.length;c++)a[c]===b&&a.splice(c,1)};wxui.metricsColors="#f44336 #9c27b0 #3f51b5 #0288d1 #009688 #558b2f #ffa000 #ff5722 #795548 #546e7a #e91e63 #1e88e5".split(" ");
